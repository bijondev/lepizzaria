...
require get_template_directory() . '/post-type/post-type-deals.php';
...
function my_login_logo() { $plugins_path = plugin_dir_path( __FILE__ ); ?>
    <style type="text/css">
    .login h1 a {
...
background-size: cover;
            background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/image/logo.png');
            padding-bottom: 20px;
        }
